...
@if($loop->index == 0)
    ...
    <meta property="og:image" content="{{$image->sizes->small->path}}"/>
    <meta property="og:image:secure_url" content="{{$image->sizes->small->path}}"/>
    <meta property="og:image:width" content="{{$image->sizes->small->width}}"/>
    <meta property="og:image:height" content="{{$image->sizes->small->height}}"/>
@endif
@endforeach
    <!-- Favicon -->
