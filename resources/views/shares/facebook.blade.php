...
@if($loop->index == 0)
    @php $height = $image->sizes->large->height; @endphp
    <meta property="og:image" content="{{$image->sizes->large->path}}"/>
    <meta property="og:image:secure_url" content="{{$image->sizes->large->path}}"/>
    <meta property="og:image:width" content="{{$image->sizes->large->width}}"/>
    <meta property="og:image:height" content="{{$image->sizes->large->height}}"/>
@endif
@endforeach
    <!-- Favicon -->
                    ...
                    <div class="product-single">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12" style="height: {{$height+10}}px">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <a href="//www.facebook.com/sharer.php?u={{route('social-detail', ['network' => 'facebook','id' => $product->id])}}" target="_blank">
                                            <img src="{{asset('details/images/share-facebook.png')}}" width="200px">
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        @if($isMobile)
                                            <a href="whatsapp://send?text={{route('social-detail', ['network' => $network,'id' => $product->id])}}?share=true" target="_blank">
                                                <img src="{{asset('details/images/share-whatsapp.png')}}" width="200px">
                                            </a>
                                        @else
                                            <a href="https://web.whatsapp.com/send?text={{route('social-detail', ['network' => $network,'id' => $product->id])}}?share=true" target="_blank">
                                                <img src="{{asset('details/images/share-whatsapp.png')}}" width="200px">
                                            </a>
                                        @endif
                                    </div>
