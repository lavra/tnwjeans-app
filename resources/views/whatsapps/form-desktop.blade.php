<div class="wa__popup_heading">
    <div class="wa__popup_intro"><strong class="text-danger">*</strong>  Significa que os campos <br>são de preenchimento obrigatórios.
        ...
        <form id="whatsapp-form" action="{{route('comment.whatsapp')}}" method="POST" onsubmit="return false">
            <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="whatsapp-name" class="text-dark">Seu Nome <span class="text-danger">*</span></label>
                ...
                <div class="form-group col-md-12 text-center">
                    <button type="submit" onclick="formWhatsapp('whatsapp-submit')" class="btn whatsapp-submit wa__popup_chat_box_btn_confirm mb-2">Enviar Mensagem</button>
                </div>
            </div>
        </form>
