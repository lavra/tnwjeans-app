    ...
    <div class="container">
        ...
        <div class="row about-content">
            <div class="col-sm-12 col-md-12 col-lg-6 about-left-side">
                ...
                <hr>
                <p>A TNW Jeans foi fundada em 2002, em São Paulo, com o intuito de ser uma referência na moda em jeans, tanto no feminino quanto no masculino.
                    Uma empresa 100% brasileira que se renova a cada coleção, trazendo para o mercado de jeans as principais tendências do Brasil e do mundo, sempre favorecendo a mão de obra e os produtos nacionais.
                    A TNW investe intensamente na qualidade e inovação de seus produtos para oferecer o melhor do jeans para os lojistas que representam a marca. </p>
                {{--
                <!-- Tabs Heading Starts -->
                ...
                --}}
                <a class="custom-button scroll-to-target" href="#lookbook">ATACADO COMPRE ONLINE</a>
            </div>
