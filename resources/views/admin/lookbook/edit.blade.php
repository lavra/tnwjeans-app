          ...
          <div class="col-md-12">
            ...
            <div class="card card-dark">
              <div class="card-header">
                <h3 class="card-title">Editar Imagem <small> Lookbook</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="upload-form" method="POST" action="{{ route('lookbook.update', $lookbook->id)}}" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-2">
                      <div class="form-check">
                        <input type="checkbox" class="form-check-input" name="active" id="image_active" @if($lookbook->active == 1) checked @endif>
                        <label class="form-check-label" for="image_active"><b>Ativo</b></label>
                        <div><img src="{{ url("storage/{$lookbook->image}") }}" alt="" width="100px" /></div>
                    ...
                    <div class="col-3">
                      <div class="form-group">
                        ...
                        <input type="number" name="order" class="form-control" id="image_order" value="{{ $lookbook->order }}">
                      </div>
                    </div>                    
